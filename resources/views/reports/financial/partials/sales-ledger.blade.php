                    ...
                    <tr class="table-success" style="background-color: #e8f5e9 !important;">
                        ...
                        <td class="text-end text-success fw-semibold" style="font-size: 12px;">
                            ...
                            <button type="button"
                                ...
                                data-bs-target="#editPaymentModalS{{ $sp['id'] }}">
                                <i class="bi bi-pencil-fill"></i> Edit
                            </button>

                            {{-- Modal Edit Pembayaran --}}
                            <div class="modal fade" id="editPaymentModalS{{ $sp['id'] }}" tabindex="-1" aria-labelledby="editPaymentModalSLabel{{ $sp['id'] }}" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        <form action="{{ route('payments.update', $sp['id']) }}" method="POST">
                                            ...
                                            <div class="modal-header py-2">
                                                <h6 class="modal-title" id="editPaymentModalSLabel{{ $sp['id'] }}">
