...
<head>
    ...
    <title>Surat Jalan Konsinyasi {{ $consignment->surat_jalan_number }}</title>
    <style>
...
<body>
    ...
    {{-- TOOLBAR --}}
    <div class="toolbar">
        <span>📄 Preview Surat Jalan Konsinyasi — {{ $consignment->surat_jalan_number }}</span>
        <div class="btn-group">
    ...
    <div class="page-wrapper">
        <div class="sj-paper">
            ...
            <div class="header-row">
                ...
                <div class="doc-title">SURAT JALAN KONSINYASI</div>
            </div>
            ...
            <div class="info-section">
                <div class="info-left">
                    ...
                    <div class="recipient-name">{{ $consignment->customer_name }}</div>
                </div>
                <div class="info-right">
                    <div class="info-row">
                        <span class="info-label">Tanggal</span>
                        <span class="info-sep">:</span>
                        <span class="info-val">{{ \Carbon\Carbon::parse($consignment->created_at)->translatedFormat('d F Y') }}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Nomer Surat Jalan</span>
                        <span class="info-sep">:</span>
                        <span class="info-val">{{ $consignment->surat_jalan_number }}</span>
                    </div>
                </div>
            </div>

            <div class="intro">Bersama ini kami kirimkan barang-barang konsinyasi (titipan) berikut ini :</div>
            ...
            <table class="items-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-qty">{{ $item->qty_total }}</td>
                    ...
                    @for($e = $consignment->items->count(); $e < 12; $e++)
                    <tr class="empty-row">
                        <td class="col-no"></td>
                        <td class="col-qty"></td>
                        <td class="col-sat"></td>
            ...
            <div style="margin-top: 12px; font-size: 11px;">
                {{ \Carbon\Carbon::parse($consignment->created_at)->translatedFormat('d F Y') }} / PX : {{ $consignment->user->name ?? '-' }}
            </div>
